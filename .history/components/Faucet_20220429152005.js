...
export default function Faucet() {
    ...
    async function requestTokens (receiver) {
        ...
        <CustomContainer>
            ...
            <form onSubmit={async e => {
                ...
                <FormControl mt="6" mb="6">
                    <FormLabel htmlFor="receiver" mt="4"> Input address to recieve 10 SICKLE tokens</FormLabel>
                    <Input id="receiver" type="text" placeholder="0x..." value={receiver} onChange={e => setReceiver(e.target.value)} />
                    {/* <NumberInput mt="4" step={1} onChange={handleChange}>
